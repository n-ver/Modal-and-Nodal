...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let client_uri = "mongodb+srv://Scraper:J2kI7KssKUvHERWN@cluster0.amzlhb5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async fn scraper(tx: mpsc::Sender<MusData>) -> Result<(), Box<dyn Error>> {
    ...
    loop {
        ...
        if let Ok(bottom_buttons) = driver.find_element(By::Css(".bottom_buttons")).await {
